...
- [ ] 14-01-PLAN.md -- Tool definitions (29 FunctionDeclarations), Zod schemas, buildAvailableTools() filter
- [ ] 14-02-PLAN.md -- Tool executor: executeToolCall() dispatcher with all 29 handlers
- [ ] 14-03-PLAN.md -- Chat route integration: Gemini multi-turn tool calling loop wiring
...
| 14. Lia — Tool System           | 0/3            | Not started | -          |
