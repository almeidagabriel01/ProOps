      ...
      <div className="relative group">
        ...
        <input
          ...
          className={cn(
            ...
            // zoom automático ao focar o campo. De md para cima segue text-sm.
            "flex h-12 w-full rounded-xl border-2 border-border/60 bg-card pl-11 pr-4 py-3 text-base md:text-sm",
