      ...
      {CANAIS.map((canal, i) => {
        ...
        return (
          ...
          >
            <FioDaConversa
              titulo={canal.titulo}
              className="conversa group block rounded-2xl border border-white/10 bg-[var(--noite-alta)]/80 p-4 transition-colors duration-300 hover:border-[rgb(var(--tungstenio)/0.45)] hover:bg-[var(--noite-alta)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[rgb(var(--tungstenio)/0.7)]"
            >
              ...
              <span className="mt-3 block text-right text-xs text-white/40 transition-colors duration-300 group-hover:text-[rgb(var(--tungstenio))]">
