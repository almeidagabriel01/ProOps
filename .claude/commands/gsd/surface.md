...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `D:/DEV/ProOps/.claude/skills/.gsd-surface.json`
...
```bash
# Claude Code
RUNTIME_CONFIG_DIR=D:/DEV/ProOps/.claude/skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=D:/DEV/ProOps/.claude/commands/gsd
AGENTS_DIR=D:/DEV/ProOps/.claude/agents
```
...
<execution_context>
Surface state file: `D:/DEV/ProOps/.claude/skills/.gsd-surface.json`
Install profile marker: `D:/DEV/ProOps/.claude/skills/.gsd-profile`
Engine module: `D:/DEV/ProOps/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `D:/DEV/ProOps/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
